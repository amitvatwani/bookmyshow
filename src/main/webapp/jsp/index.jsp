        ...
        <body>
                    ...
                    <div class="sidebar-items">
                        <c:if test="<%=user!=null%>">
                            <c:if test='<%=user.getUserRole().equals("ROLE_USER")%>'>
                                ...
                                <a href="theatre/theatreForm" style="text-decoration: none;color:#00b8f5;margin-top:5%">Partner with us</a>
                            ...
                            <div class="movie-card-holder">
                                <c:forEach var="movie" items="${movies}">
                                    <div class="movie-card">
                                        ...
                                        <form action="selectMovieTheatres?date=<%=(new java.util.Date())%>" id="selectMovieTheatres">
                                            <div class="movie-card-6">
                                                <input type="hidden" name="movieId" value="${movie.movieId}">
                                                <a class="movie-card-7" onclick="submitMovieForm()">                                                    Book Ticket
                                                </a>
                                            </div>
                                        </form>
                                    </div>
            ...
            <script>
                ...
                function submitMovieForm(){
                    ...
                    cityId.setAttribute("name", "cityId")
                    cityId.setAttribute("type", "hidden")
                    cityId.value = document.getElementById("theatreCityId").value;
